...
const FooterLink = ({ nom, url, onClick, hidden }) => {
  return (
    <a
      href={url}
      onClick={onClick}
...
const Footer = ({ toggleAbout, toggleRobot }) => {
  ...
  return (
    <div className="flex justify-between items-center bg-[#191919] text-[#A7A7A7] w-full">
      ...
      <div className="flex w-[98%] gap-[5%] text-[18px] items-center justify-center">
        <FooterLink nom="Home" url="#home" hidden={true} />
        <FooterLink nom="About" url="#about" onClick={toggleAbout} />
        <FooterLink nom="Projects" url="#projects" />
        <FooterLink nom="Contact" url="#" onClick={handleContactClick} hidden={true} />
      </div>
